...
const ICONS = {
  ...
  twitter: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.259 5.63 5.905-5.63Zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>'
};
...
function populateFooter() {
  ...
  if (footerSocial) {
    ...
    if (s.twitter) footerSocial.innerHTML += `<a href="${s.twitter}" target="_blank">${ICONS.twitter}</a>`;
  }
...
function openSocialModal(platform) {
  ...
  if (platform === 'facebook') {
    content.innerHTML = `
      <iframe 
        src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D61589275235372&tabs=timeline&width=420&height=600&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=false"
    ...
    content.innerHTML = `
      <div style="padding: 8px;">
        <a class="twitter-timeline" data-height="580" data-theme="light"
           href="https://twitter.com/AirnetKe?ref_src=twsrc%5Etfw">Tweets by AirnetKe</a>
        <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"><\/script>
      </div>`;
    // Reload twitter widget if already loaded
...
function closeSocialModal() {
  ...
  if (content) content.innerHTML = ''; // destroy embed to stop loading
  document.body.style.overflow = '';
}
